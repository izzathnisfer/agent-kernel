...
# Tracing is transparent: the agents behave identically to the plain pydanticai demo — Logfire only
# adds observability. These smoke tests assert that behaviour is unchanged while tracing is enabled.
@pytest.mark.order(1)
