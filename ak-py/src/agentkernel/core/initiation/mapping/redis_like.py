...
class _RedisLikeSessionIdMappingStore(SessionIdMappingStore):
    ...
    def get_session_id(self, messaging_integration_thread_id: str) -> Optional[str]:
        ...
        """
        return self._driver.get(self._driver.key(thread_record_key(messaging_integration_thread_id)))
    ...
    def get_messaging_integration_thread_id(self, session_id: str) -> Optional[str]:
        ...
        """
        return self._driver.get(self._driver.key(session_record_key(session_id)))
    ...
    def save(self, session_id: str, messaging_integration_thread_id: str) -> None:
        ...
        self._driver.set(self._driver.key(thread_record_key(messaging_integration_thread_id)), session_id)
        self._driver.set(self._driver.key(session_record_key(session_id)), messaging_integration_thread_id)
