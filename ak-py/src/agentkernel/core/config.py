...
class _TeamsConfig(BaseModel):
    ...
    app_id: str = Field(default="", description="Azure Bot / App Registration application (client) ID")
    app_password: str = Field(default="", description="Azure Bot / App Registration client secret")
    tenant_id: str = Field(default="", description="Azure AD tenant ID (empty for multi-tenant, i.e. 'common')")
