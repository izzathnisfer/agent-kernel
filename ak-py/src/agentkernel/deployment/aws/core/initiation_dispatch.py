...
def _dispatch_to_output_queue(initiation: InitiationMessage) -> None:
    """
    ...
    """
    _log.info(f"Enqueuing initiation for session {initiation.session_id} to the Output Queue")
...
def register_initiation_queue_dispatcher() -> None:
    """
    ...
    """
    InitiationManager.register_dispatcher(_dispatch_to_output_queue)
