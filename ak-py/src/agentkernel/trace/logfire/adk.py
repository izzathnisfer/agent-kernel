...
class LogfireADKRunner(GoogleADKRunner):
    ...
    def __init__(self):
        ...
        # Google ADK ships no Logfire-native instrumentor. Reuse the OpenInference instrumentor
        # bundled with the adk extra — its spans flow into Logfire's global tracer provider.
